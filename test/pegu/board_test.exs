defmodule Pegu.BoardTest do
  ...
  test "#tokens returns the number of ones in the board" do
    board_1 = {
      {1,0,0},
      {0,1,1}
    }
    ...
    assert Pegu.Board.tokens(board_1) == 3
    assert Pegu.Board.tokens(board_2) == 4
    assert Pegu.Board.tokens(board_3) == 1
    assert Pegu.Board.tokens(board_4) == 1
  end
